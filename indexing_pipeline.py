...
class ImageLoader:
    # Loads images from dataset directory using CSV labels
...
class EmbeddingModel:
    # Pre-trained CLIP model for image embeddings
...
class IndexingPipeline:
    # Main pipeline that orchestrates image loading, embedding, and storage
